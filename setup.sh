...
# -------------------------------
# Ubuntu Setup Script (App Center style, no Spotify/Opera)
# -------------------------------
...
# -------------------------------
# 3. Add external repos for Chrome & VS Code
# -------------------------------
echo -e "${BLUE}🔧 Adding Chrome and VS Code repositories...${NC}"
...
MAIN_APPS=(telegram-desktop code google-chrome-stable)
